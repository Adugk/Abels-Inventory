  ...
  return `
    <nav id="sidebar" aria-label="Main navigation">
      ...
      <div class="sidebar-user">
        ...
        <div class="sidebar-user-name">${email.split('@')[0] || 'User'}</div>
        <div class="sidebar-user-role">Construction Manager</div>
      </div>
      ...
      <div class="sidebar-promo">
        ...
        <div class="sidebar-promo-title">Abel's Construction</div>
        <div class="sidebar-promo-sub">Manage inventory, sales &amp; purchases in one place</div>
      </div>
